...
// source code: https://docs.oracle.com/javase/tutorial/uiswing/examples/components/index.html#TextFieldDemo
...
public class TextFieldDemo extends JFrame
    ...
    public TextFieldDemo(String file) {
        initComponents(file);
        this.file = file;
    ...
    public static void main(String args[]) {
    	...
    	SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                new TextFieldDemo("content").setVisible(true);
            }
        });
    }
